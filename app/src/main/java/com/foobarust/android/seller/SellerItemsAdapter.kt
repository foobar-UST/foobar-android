...
import com.foobarust.android.databinding.SellerItemInfoContentBinding
import com.foobarust.android.seller.SellerItemsAdapter.SellerItemsAdapterListener
...
class SellerItemsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SellerItemsViewHolder {
        ...
        return SellerItemsViewHolder(
            SellerItemInfoContentBinding.inflate(inflater, parent, false),
            listener
        )
    }
...
class SellerItemsViewHolder(
    val binding: SellerItemInfoContentBinding,
