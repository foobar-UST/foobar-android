...
import com.foobarust.testshared.serialize.*
...
class FakeSellerRepositoryImpl : SellerRepository {
    ...
    val sellerList: List<SellerSerialized> by lazy {
        deserializeJsonList("sellers_fake_data.json")
    }

    val sellerCatalogList: List<SellerCatalogSerialized> by lazy {
        deserializeJsonList("seller_catalogs_fake_data.json")
    }

    val sellerItemList: List<SellerItemSerialized> by lazy {
        deserializeJsonList("seller_items_fake_data.json")
    }

    val sellerSectionList: List<SellerSectionSerialized> by lazy {
        deserializeJsonList("seller_sections_fake_data.json")
    }

    val itemCategoryList: List<ItemCategorySerialized> by lazy {
        deserializeJsonList("item_categories_fake_data.json")
    }

    val sellerRatingList: List<SellerRatingSerialized> by lazy {
