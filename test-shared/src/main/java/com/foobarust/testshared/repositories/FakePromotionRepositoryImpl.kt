...
import com.foobarust.testshared.serialize.AdvertiseSerialized
import com.foobarust.testshared.serialize.toAdvertiseBasic
...
class FakePromotionRepositoryImpl : PromotionRepository {
    ...
    val advertiseList: List<AdvertiseSerialized> by lazy {
