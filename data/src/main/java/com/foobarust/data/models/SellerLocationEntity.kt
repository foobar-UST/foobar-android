...
data class SellerLocationEntity(
    @JvmField
    @PropertyName(SELLER_LOCATION_ADDRESS_FIELD) val address: String? = null,

    @JvmField
    @PropertyName(SELLER_LOCATION_GEOPOINT_FIELD) val geoPoint: GeoPoint? = null
)