...
@Serializable
internal data class SellerItemSerialized(
    val id: String,
    val title: String,
...
internal fun SellerItemSerialized.toSellerItemDetail(): SellerItemDetail {
...
internal fun SellerItemSerialized.toSellerItemBasic(): SellerItemBasic {
